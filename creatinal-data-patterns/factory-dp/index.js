...
var Creator = /** @class */ (function () {
    ...
    Creator.prototype.otherOparation = function () {
        var product = this.factoryMethod();
        return "Creator: The same Creator's code has jusr worked with ".concat(product.operation);
    };
    return Creator;
}());
...
function clientCode(creator) {
    ...
    console.log(creator.otherOparation());
}
